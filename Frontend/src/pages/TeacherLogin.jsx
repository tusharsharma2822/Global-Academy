  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
      ...
      <img className='w-100 mx-auto' src="https://upload.wikimedia.org/wikipedia/en/thumb/0/0a/Global_Academy_logo.svg/768px-Global_Academy_logo.svg.png?20210928174133" alt='' />
        <form>
          <h3 className='text-xl mt-3 font-medium mb-2'>What&apos;s your email?</h3>
        ...
        <p className='text-center'>Join as a Teacher?<Link to='/teacher-signup' className='text-blue-600'>Register Here</Link></p>
      </div>
      <div>
        <Link to='/student-login' className='bg-[#697565] flex items-center justify-center text-white font-semibold mb-5 rounded px-4 py-2 w-full text-lg placeholder:text-base'>Sign In as Student</Link>
      </div>
    </div>
  )
}
